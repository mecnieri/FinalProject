        ...
        <div className="container">
          <div className="container_1-of-5">
            <div className="container_1-of-5-logo">
              <img
                className="container_1-of-5-logo--image"
                src={logo}
                alt="Logo"
              />
            </div>
            ...
            <div className="social-icons">
              ...
              <ul>
                <li>
                  <p className="fab fa-facebook" />
                </li>
                <li>
                  <p className="fab fa-twitter" />
                </li>
                <li>
                  <p className="fab fa-pinterest" />
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-container">
          ...
          <div className="payment-methods">
            <ul>
              <li>
                <img src={visa} width="40" height="29" alt="visa" />
              </li>
              <li>
                <img src={mastercard} width="40" height="29" alt="mastercard" />
              </li>
              <li>
                <img src={paypal} width="40" height="29" alt="paypal" />
              </li>
              <li>
                <img src={skrill} width="40" height="29" alt="skrill" />
              </li>
              <li>
                <img src={discover} width="40" height="29" alt="discover" />
              </li>
            </ul>
          </div>
        </div>
