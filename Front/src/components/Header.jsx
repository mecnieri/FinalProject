            ...
            <ul className="right">
              {this.props.showLogin && (
                <li className="menu--item">
                  <Link
                    to="/login"
                    style={{ display: this.props.adminLog ? "none" : "block" }}
                  >
                    Login
                  </Link>
                </li>
              ...
              {this.props.adminLog && (
                <li onClick={<Redirect to="/" />} className="menu--item">
                  <Link to="/">Log Out</Link>
                </li>
              )}
            </ul>
